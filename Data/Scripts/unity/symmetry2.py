...
def DuplicateNullSymmetry(null,parent):
	...
	t = d.Kinematics.Global.Transform
	s = null.Kinematics.Global.Transform
...
def DuplicateSkeletonSymmetry(root):
	dup = xsi.DuplicateSymmetry(root,0,"",1,0,0)(0)
...
s = xsi.Selection(0)
if s.Type == "null":		 
	DuplicateNullSymmetry(s,None)
elif s.Type == "root":
	DuplicateSkeletonSymmetry(s)
