...
if sel:
	...
	if model.Groups("Plot_Orientation") and model.Groups("Plot_Position"):
		...
		xsi.PlotAndApplyActions(GetRotParameters(ori.Members),"plot", startframe, endframe, "", 20, 3, "", "", "", "", True, True)
		xsi.PlotAndApplyActions(GetPosParameters(pos.Members),"plot", startframe, endframe, "", 20, 3, "", "", "", "", True, True)
		...
		# first we clean the FCurves(removing all unecessary keys)
		for m in marked:
			source = m.Source
