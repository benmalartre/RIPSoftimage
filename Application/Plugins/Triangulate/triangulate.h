...
struct ITriangulate
{
  ...
  static ITriangulate<T, I>* Create();
...
protected: virtual ~ITriangulate() = 0; // please use Destroy()
};

template <typename T, typename I>
inline const typename ITriangulate<T, I>::Simplex* ITriangulate<T, I>::Simplex::StartIterator(ITriangulate<T, I>::Iterator* it/*not_null*/, int around/*0,1,2*/) const
{
  it->current = this;
  it->around = around;
  return this;
...
template <typename T, typename I>
inline const typename ITriangulate<T, I>::Simplex* ITriangulate<T, I>::Vertex::StartIterator(ITriangulate<T, I>::Iterator* it/*not_null*/) const
{
  it->current = sew;
  if (sew->v[0] == this)
    it->around = 0;
