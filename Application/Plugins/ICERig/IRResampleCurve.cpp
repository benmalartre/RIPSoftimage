...
CStatus RegisterIRResampleCurve( PluginRegistrar& in_reg )
{
  ...
  st = nodeDef.AddInputPort(
    ...
    L"Position", L"Position", CVector3f(1.0,1.0,1.0), ID_UNDEF, ID_UNDEF, ID_CTXT_CNS
  );
  st.AssertSucceeded( ) ;

  st = nodeDef.AddInputPort(
    ID_IN_Count, ID_G_100, siICENodeDataLong, siICENodeStructureSingle, siICENodeContextAny,
    L"Count", L"Count", 5, ID_UNDEF, ID_STRUCT_CNS, ID_CTXT_CNS
  );
  st.AssertSucceeded( ) ;

  st = nodeDef.AddInputPort(
    ID_IN_Min, ID_G_100, siICENodeDataFloat, siICENodeStructureSingle, siICENodeContextAny,
    L"Min", L"Min", 0.0f, ID_UNDEF, ID_UNDEF, ID_UNDEF
  );
  st.AssertSucceeded( ) ;

  st = nodeDef.AddInputPort(
    ID_IN_Max, ID_G_100, siICENodeDataFloat, siICENodeStructureSingle, siICENodeContextAny,
    L"Max", L"Max", 1.0f, ID_UNDEF, ID_UNDEF, ID_UNDEF
  );
  st.AssertSucceeded( ) ;
  ...
  st = nodeDef.AddOutputPort(
    ID_OUT_Result, ID_G_300, siICENodeDataVector3, siICENodeStructureArray, siICENodeContextAny,
